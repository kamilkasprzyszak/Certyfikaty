...
### 1. Finotive Funding – Certificate of Achievement
* **Data uzyskania:** 27 maja 2026 r.[cite: 7]
* Ukończyłem z sukcesem dwuetapowy proces ewaluacji, zarządzając kontem o wartości 5 000 USD[cite: 7].
* Certyfikat potwierdza moją ścisłą dyscyplinę oraz umiejętność handlu z zastosowaniem rygorystycznych praktyk zarządzania ryzykiem[cite: 7].
...
### 2. Wykorzystanie AI w rozwoju firmy – Google & SGH
* **Data uzyskania:** 17 czerwca 2026 r.[cite: 8, 9]
* Z sukcesem ukończyłem pięciotygodniowy program szkoleniowy w ramach inicjatywy Google Umiejętności Jutra AI[cite: 8, 9].
* Program realizowany był przez organizatora – firmę Google, we współpracy z partnerem edukacyjnym, czyli SGH[cite: 8, 9].
* Szkolenie zakończyłem uzyskaniem pozytywnego wyniku z egzaminu końcowego[cite: 8, 9].
...
* **Data uzyskania:** 11 kwietnia 2026 r.[cite: 10]
* Ukończyłem autoryzowany przez Google kurs online z podstaw danych, oferowany i certyfikowany przez platformę Coursera[cite: 10].
...
Wszystkie powyższe certyfikaty stanowią spójną całość. Umiejętności analityczne zdobyte na szkoleniach z danych i AI wykorzystuję w praktyce do budowy narzędzi i optymalizacji, natomiast certyfikat z firmy proptradingowej jest bezpośrednim dowodem na to, że potrafię chłodno egzekwować zbudowane systemy z naciskiem na ochronę kapitału.
